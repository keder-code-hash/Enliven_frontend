                    ...
                    <div className="card">
                      <div className="card-body">
                        <div className="d-flex flex-column align-items-center text-center">
                          ...
                          <div className="mt-3">
                            <h4>John Doe</h4>
                            <p className="text-secondary mb-1">Learner</p>
                  ...
                  <div className="col-md-8">
                      ...
                      <div className="card-body">
                        ...
                        <div className="row">
                          <div className="col-sm-12">
                            ...
                            <a className="btn btn-warning " target="__blank" href="https://www.bootdey.com/snippets/view/profile-edit-data-and-skills">Change Password</a>
                            <a className="btn btn-danger " target="__blank" href="https://www.bootdey.com/snippets/view/profile-edit-data-and-skills">Delete Account</a>
                          </div>
                        </div>
                      </div>
                    </div>
                    <div className="row gutters-sm">
                      <div className="col-sm-6 mb-3">
                        <div className="card h-100">
                          <div className="card-body">
                            <h6 className="d-flex align-items-center mb-3">Assessment Status</h6>
                            <small>Correctly Answered</small>
                      ...
                      <div className="col-sm-6 mb-3">
                        <div className="card h-100">
                          <div className="card-body">
                            <h6 className="d-flex align-items-center mb-3">Assessment Analytics</h6>
                            <div id="assessmentChart" style={{maxWidth: '300px', height: '300px'}} />
                          </div>
                        </div>
                      </div>
                    </div>
                    <div className="row gutters-sm">
                      <div className="col-sm-12 mb-3">
                        <div className="card h-100">
                          <div className="card-body">
                            <h6 className="d-flex align-items-center mb-3">Analytics</h6>
                            <div id="analyticsChart" style={{maxWidth: '700px', height: '400px'}} />
                          </div>
                        </div>
                      </div>
                    </div>
